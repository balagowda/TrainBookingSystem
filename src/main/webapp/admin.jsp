...
%>
	...
	<div class="container">
		...
		<form action="CustomerServlet" method="get">
			<button name="action" value="AllData" class="btn">Update Customer Profile</button>
		</form>
			<a href="registertrain.jsp" class="btn">Register Train</a>
			<form action="TrainServlet" method="get">
				<input type="hidden" name="user" value="admin">
				<button name="action" value="View" class="btn">View All Trains</button>
			</form>  
			<form action="BookingServlet" method="get">
				<button name="action" value="AllBooking" class="btn">View Ticket List</button>
			</form>
		</div>
		<div class="charts">
